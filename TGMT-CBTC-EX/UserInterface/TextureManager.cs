...
namespace TGMTAts {
    ...
    class TextureManager {
        ...
        public static Texture CreateTdtTexture(Device device) {
            ...
            TdtTexture = new Texture(device, 256, 256, 1, Usage.None, Format.A8R8G8B8, Pool.Managed);
            return TdtTexture;
        }

        public static void UpdateTexture(Texture texture, Bitmap bmp) {
            if (texture == null || bmp == null) return;
